...
El video de BBB original se llama Big_Buck_Bunny.mp4, necesario para el primer ejercicio,
 y el cortado se llama cut_video_12_seconds.mp4 (el cual se crea en el primer ejercicio) y
 es útil para los otros ejercicios
"""
